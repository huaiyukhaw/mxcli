---
name: mendix-assess-migration
description: "Use when investigating an existing non-Mendix application to produce a structured assessment for migrating it to Mendix."
---
