---
name: mendix-patterns-crud
description: "Use when implementing Create/Read/Update/Delete microflow logic — standard CRUD action patterns and naming conventions."
---
