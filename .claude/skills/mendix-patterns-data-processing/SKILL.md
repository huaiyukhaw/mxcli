---
name: mendix-patterns-data-processing
description: "Use when processing lists of data — loops, aggregates, batch processing, delta merge, and list-operation patterns. Read before writing list-processing microflows."
---
